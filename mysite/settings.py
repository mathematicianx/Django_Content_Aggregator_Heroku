...
AWS_ACCESS_KEY_ID = 'AKIAIMYB66FT4YPSJYWA'
AWS_SECRET_ACCESS_KEY = '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'
...
AWS_LOCATION1 = 'static'
AWS_LOCATION2 = 'media'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'homepage/static'),
]

STATIC_URL = 'https://%s/%s/' % (AWS_S3_CUSTOM_DOMAIN, AWS_LOCATION1)
